...
ActiveRecord::Schema.define(version: 20140622141209) do
  ...
  add_index "article_links", ["alias"], name: "index_article_links_on_alias", using: :btree
  add_index "article_links", ["city_id", "alias"], name: "index_article_links_on_city_id_and_alias", unique: true, using: :btree
  add_index "article_links", ["city_id"], name: "index_article_links_on_city_id", using: :btree
  ...
  add_index "city_articles", ["city_id", "article_id"], name: "index_city_articles_on_city_id_and_article_id", unique: true, using: :btree
  add_index "city_articles", ["city_id"], name: "index_city_articles_on_city_id", using: :btree
  ...
  add_index "city_news", ["city_id", "news_id"], name: "index_city_news_on_city_id_and_news_id", unique: true, using: :btree
  add_index "city_news", ["city_id"], name: "index_city_news_on_city_id", using: :btree
  add_index "city_news", ["news_id"], name: "index_city_news_on_news_id", using: :btree
